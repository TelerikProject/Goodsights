...
router
    ...
    .on('/users', () => container.html('users'))
    .on('/users/:username', (params) => container.html('Showing info for current user'))
    .on('/sign-in', () => container.html('sign-in'))
    .on('/sign-up', () => container.html('sign-up'))
